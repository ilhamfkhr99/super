        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-2">
              <div class="col">
                <h2 class="h3 mb-0 page-title">Data Unit</h2>
                <ol class="breadcrumb -left">
                    <li class="breadcrumb-item"><a href="{{ url('super/bidang') }}">Data Organisasi</a></li>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="VaryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="varyModalLabel">Tambah Unit</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form class="form-horizontal" action="{{ url('super/tambah-unit/'.$id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="unit" class="form-label"><strong>Nama Unit</strong></label>
                            <input type="hidden" class="form-control" name="id_parent" id="id_parent" value="{{ $id }}">
...
<div class="modal fade" id="edit-{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="varyModalLabel">Edit Unit</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form class="form-horizontal" action="{{ url('super/edit-unit/'.$id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="unit" class="form-label"><strong>Kategori</strong></label>
...
<div class="modal fade" id="hapus-{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="{{ url('super/hapus-unit/'.$id.'/'.$row->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('delete')
                <div class="row">
                    <div class="col-md-12">
